...
(16, 'Riddhi Kakkar', 'riddhikakkar@gmail.com', 'Testing Purpose', 'Hi There!', '2023-07-10 10:54:08');
...
(12, 'Test User 1', 'testuser1@couriertracker.com', '0700000000', '971212125V', 'No 232, Mumbai', 1, 'testuser1', 0),
(13, 'Test USer 2', 'testuser2@couriertracker.com', '0701111111', '971212123V', 'No 780, Delhi', 1, 'testuser2', 0);
...
(1, '', 'admin', '', '', '', 0, '12345', 0, 0),
(12, 'EMP1', 'emp1@couriertracker.com', '0770000000', '975001820V', 'No 800, Mumbai', 1, 'emp1', 0, 6),
(13, 'EMP2', 'emp2@couriertracker.com', '0771111111', '977854562V', 'No 750, Delhi', 1, 'emp2', 0, 9);
...
(8, '7', '23', 100, 0, '2023-07-01 12:16:56'),
(9, '7', '26', 120, 0, '2023-07-02 12:17:15'),
(10, '22', '7', 50, 0, '2023-07-03 12:17:42'),
(11, '25', '22', 200, 0, '2023-07-04 12:18:06'),
(12, '22', '25', 170, 0, '2023-07-05 12:22:42');
...
('Header.jpg', 'Welcome to Courier Tracker', 'Your Premier Domestic Courier Service Provider', 'About Us', 'Courier Tracker is an Indian premier domestic courier service provider. With the strength of an experienced and talented team, Courier Tracker functions with the utmost confidence in the broadest coverage, security, and timely delivery of your important documents and packages. Courier Tracker also has a strong background in logistics management. As a result of the trust we have built with our corporate clients, Courier Tracker is now the official courier for a number of entities in Sri Lanka. Courier Tracker upholds high service standards and quality levels to ensure that your packages and documents are handled by professionals.', '+9477-1233254', 'connect@couriertracker.com', 'No 224, Nehru Road, Mumbai, India', 'Sub_Header.jpg', 'About.jpg', 'https://www.facebook.com/', 'https://www.twitter.com/', 'https://www.instagram.com/', 'Background.jpg');
